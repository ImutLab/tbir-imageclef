...
dictionary_prefix = '/media/dmacjam/Data disc/Open data/TBIR/processed_data/teaser/'
...
textual_image_ids_filename = '/media/dmacjam/Data disc/Open data/TBIR/data_6stdpt/Teaser/scaleconcept16.teaser_dev.TextID.txt'
visual_image_ids_filename = '/media/dmacjam/Data disc/Open data/TBIR/data_6stdpt/Teaser/scaleconcept16.teaser_dev.ImgID.txt'
ground_truth_filename = '/media/dmacjam/Data disc/Open data/TBIR/data_6stdpt/Teaser/scaleconcept16.teaser_dev.ImgToTextID.txt'
